...
$(function () {
	...
	$("#signup").click(function(){
		...
		let main_address = document.form1.main_address.value;
	    ...
	    if (main_address == "") {
	        alert("주소를 입력해주세요.");
	        document.form1.main_address.focus();
	        return;
	    }
		
	    
	    document.form1.action = "/admin/insertUser";
...
<div class="container">
    ...
    <form name="form1" method="post">
        ...
        <label for="main_address">주소</label>
        <textarea name="main_address" id="main_address" placeholder="주소를 입력해주세요."></textarea>
		<label for="sub_address">상세주소</label>
		<textarea name="sub_address" id="sub_address" placeholder="상세주소를 입력해주세요."></textarea>
